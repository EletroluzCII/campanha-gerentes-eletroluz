  ...
  async submitMetrics(values, onProgress = () => {}) {
    ...
    if (isDemo) {
      ...
      const record = {
        ...
        discount_under_500_percentage: values.metricKind === 'profitability' ? null : Number(values.discountUnder500Percentage),
        discount_under_500_points: values.metricKind === 'profitability' ? null : score.discountUnder500Points,
        discount_501_to_2000_percentage: values.metricKind === 'profitability' ? null : Number(values.discount501To2000Percentage),
        discount_501_to_2000_points: values.metricKind === 'profitability' ? null : score.discount501To2000Points,
    ...
    return assertNoError(await supabase.rpc('submit_metrics', {
      ...
      p_discount_under_500_percentage: values.metricKind === 'profitability' ? null : Number(values.discountUnder500Percentage),
      p_discount_501_to_2000_percentage: values.metricKind === 'profitability' ? null : Number(values.discount501To2000Percentage),
